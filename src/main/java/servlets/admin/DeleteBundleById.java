        ...
        try {
            ...
            if (e.getSQLState().equals("23503")) {
                ...
                errors.put("deleteError", 
                    "This bundle cannot be deleted because it is currently associated with active transactions. " +
                    "As an alternative, you can set the bundle as inactive to hide it from customers.");
