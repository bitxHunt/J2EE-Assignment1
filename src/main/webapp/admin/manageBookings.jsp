	...
	<div class="p-8">
				...
				<tbody>
					<c:forEach var="booking" items="${bookings}">
						<tr>
							...
							<td>
								<div
									class="badge ${booking.status == 'PENDING' ? 'badge-warning' : 
		...
		<div class="flex justify-center mt-4 space-x-2">
			<c:if test="${currentPage > 1}">
				<a
					href="?page=${currentPage - 1}&postalCode=${postalCode}&startDate=${startDate}&endDate=${endDate}"
					class="btn btn-sm">Previous</a>
			</c:if>

			<c:forEach begin="1" end="${totalPages}" var="pageNum">
				<a
					href="?page=${pageNum}&postalCode=${postalCode}&startDate=${startDate}&endDate=${endDate}"
			...
			<form method="POST"
				...
				<div class="form-control">
					<label class="label"> <span class="label-text">Select
							Staff</span>
					</label> <select class="select select-bordered w-full" name="staffId"
						required>
