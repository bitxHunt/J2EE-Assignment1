...
<body class="bg-base-100">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="${pageContext.request.contextPath}/register-organization" class="btn btn-primary">
                    ...
                    <div class="card bg-base-200 shadow-xl">
                        <div class="card-body">
                            ...
                            <div class="space-y-4 mt-4">
                                <div>
                                    <label class="text-sm font-semibold mb-1 block">Access Key</label>
                                    <div class="flex items-center gap-2">
                                        <input type="text" value="<%= org.getAccessKey() %>" 
                                               class="input input-bordered w-full" readonly />
                                        <button onclick="copyToClipboard(this, '<%= org.getAccessKey() %>')" 
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <button onclick="copyToClipboard(this, '<%= org.getSecretKey() %>')" 
                                                class="btn btn-square btn-ghost">
                                            <span class="material-symbols-outlined">content_copy</span>
                                        </button>
                                    </div>
        ...
        <% } else { %>
            <div class="text-center py-16">
                <span class="material-symbols-outlined text-6xl text-base-content/50 mb-4">business</span>
                <h3 class="text-xl font-semibold mb-2">No Organizations Yet</h3>
                <p class="text-base-content/70 mb-6">Create your first organization to get started.</p>
                <a href="${pageContext.request.contextPath}/register-organization" class="btn btn-primary">
                    <span class="material-symbols-outlined">add_business</span>
                    Create Organization
                </a>
