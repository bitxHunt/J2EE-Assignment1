...
<body class="min-h-screen bg-base-100">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="text-center mb-16">
            <h1 class="text-5xl font-bold bg-gradient-to-r from-primary to-secondary inline-block text-transparent bg-clip-text">
                Service Categories
            </h1>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            %>
            <div class="card bg-base-200/50 hover:bg-base-200 transition-all duration-300 shadow-lg hover:shadow-primary/20">
                <div class="card-body p-8">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <div class="badge badge-secondary">
                                <%=category.getServiceCount()%> Services Available
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Services List -->
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold mb-3 text-base-content/80">Available Services:</h3>
                        <div class="space-y-2">
                            <%
